...
എന്റെ ന്യൂ ഫീച്ചേർസ് ചാനലിൽ @Mothirajinn_bot ഇടുന്നതായിരിക്കും. സംശയങ്ങൾക്ക് @cybersecurityhacker എന്ന ഐഡിയിൽ മെസ്സേജ് അയക്കുക....

എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](tg://user?id={}) ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/Ashikmuhammedjinn/Marie_Chechi2.0) കാണാവുന്നതാണ്...
...
എന്റെ ചേച്ചിയായ [Marie](http://telegram.dog/Mothirajinn_bot) ഉപയോഗിക്കുന്നത് എല്ലായ്പ്പോഴും എളുപ്പമായിരിക്കും. മോതിര ജിന്നിന് English മാത്രമേ അറിയൂ..
