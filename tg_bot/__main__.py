...
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് [click](https://heroku.com/deploy?template=https://github.com/Ashikmuhammedjinn/Marie_Chechi2.0) കാണാവുന്നതാണ്...
എന്നെ ഉപയോഗിക്കാൻ ആവിശ്യമായ commandകൾ അറിയാൻ /help കൊടുത്താൽ മതിയാകും..
വിവരങ്ങൾക്കായി /info  ഉപയോഗിക്കാവുന്നതാണ്...

Using standard [മോതിര ജിന്ന്](http://telegram.dog/Mothirajinn_bot) is always gonna be easier.
എന്റെ ചേച്ചിയായ [മോതിര ജിന്ന്](http://telegram.dog/Mothirajinn_bot) ഉപയോഗിക്കുന്നത് എല്ലായ്പ്പോഴും എളുപ്പമായിരിക്കും. മോതിര ജിന്നിന് English മാത്രമേ അറിയൂ..
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya, How can I help you? 🙂",reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="❓ Help",url="t.me/{}?start=help".format(bot.username)),InlineKeyboardButton(text=" Mai source",url="https://t.me/Mothirajinn_bot")]]))
